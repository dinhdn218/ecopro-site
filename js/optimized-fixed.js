// JavaScript optimisé pour les performances avec correction du chargeur de page

// Fonction pour masquer le chargeur de page
function hidePageLoader() {
    const pageLoader = document.querySelector('.page-loader');
    if (pageLoader) {
        pageLoader.classList.add('loaded');
        // Supprimer complètement le chargeur après la transition
        setTimeout(() => {
...
function init() {
    ...
    // Masquer le chargeur de page immédiatement
    hidePageLoader();
...
// Masquer le chargeur de page si le chargement prend trop de temps
// Fallback de sécurité pour s'assurer que le chargeur disparaît même en cas de problème
window.addEventListener('load', hidePageLoader);
setTimeout(hidePageLoader, 3000); // Masquer après 3 secondes maximum
